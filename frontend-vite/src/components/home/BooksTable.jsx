    ...
    <table className='w-full border-separate border-spacing-2'>
          <thead>
            <tr>
              ...
              <th className='border border-slate-600 rounded-md max-md:hidden p-2'>Author</th>
              <th className='border border-slate-600 rounded-md max-md:hidden p-2'>Published Year</th>
          ...
          <tbody>
            {books?.map((book, index) => (
              <tr key={index} className='h-8'>
                ...
                <td className='border border-slate-700 rounded-md text-center p-2'>{book.author}</td>
                <td className='border border-slate-700 rounded-md text-center p-2'>{book.publishYear}</td>
